...
import "./HeaderNav4.css";

const HeaderNav4: FunctionComponent = () => {
  return (
    <header className="header-nav6">
      ...
      <div className="search-bar1">
        <div className="loginsignup3">Login/Signup</div>
      </div>
    </header>
  );
};

export default HeaderNav4;
